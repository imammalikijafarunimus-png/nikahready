...
// Refactored: Mobile-first grid for age range
// ============================================================
    ...
    <div className="space-y-5">
      ...
      <div className="flex gap-3 p-3 rounded-xl bg-navy-900/60 border border-navy-800">
        ...
        <p className="text-xs text-navy-400 leading-relaxed">
          ...
          Tetap terbuka — terkadang <strong className="text-white">jodoh terbaik datang dari yang tidak pernah kamu sangka</strong>.
        </p>
      </div>
    </div>
  )
